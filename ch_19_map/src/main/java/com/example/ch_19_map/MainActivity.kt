...
class MainActivity : AppCompatActivity(), OnMapReadyCallback, GoogleMap.InfoWindowAdapter {
    ...
    override fun getInfoWindow(marker: Marker): View? {
        ...
        val detailButton = infoWindow.findViewById<TextView>(R.id.detailButton)
    ...
    override fun onMapReady(map: GoogleMap) {
        googleMap = map
        googleMap?.setInfoWindowAdapter(this) // 커스텀 정보창 어댑터 설정
        ...
        // 서울 시청으로 초기 지도 위치 설정 (위치 권한 거부 시 대비)
